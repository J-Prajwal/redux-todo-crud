...
const Sidebar = () => {
  ...
  return (
    <Box border="" width="250px" height="100vh">
      <Stack direction="column">
        ...
        <Box height="10vh" border="1px solid red" display={"flex"} alignItems={"center"}>
          <Button width="100%" height={"100%"}>{isAuth && "LOGOUT"}</Button>
        </Box>
      </Stack>
    </Box>
  );
